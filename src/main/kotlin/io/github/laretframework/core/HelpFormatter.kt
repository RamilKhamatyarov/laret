...
import io.github.laretframework.ui.green
import io.github.laretframework.ui.redBold
...
object HelpFormatter {
    ...
    private fun formatPlugins(app: CliApp): String = app.getSidecarPlugins()
        .filter { it.status == io.github.laretframework.plugin.model.PluginStatus.INSTALLED }
        .joinToString("\n") { plugin ->
    ...
    fun showValidationError(error: io.github.laretframework.model.ValidationError) {
