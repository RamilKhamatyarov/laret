package io.github.laretframework.man

import io.github.laretframework.completion.GroffFormatter
import io.github.laretframework.completion.ManPageGenerator
import io.github.laretframework.completion.ManSection
import io.github.laretframework.model.Argument
...
class ManPageGeneratorTest {
    ...
    fun `generateGroup writes one file per command`(@TempDir tmp: File) {
        ...
        val group = io.github.laretframework.model.CommandGroup(
            name = "file",
